...
echo $&max_iavdd > CACE\{simpath\}/CACE\{filename\}_CACE\{N\}.data
quit
.endc
"
...
only_toplevel=false 
value="* CACE gensim simulation file CACE\{filename\}_CACE\{N\}
...
C {devices/vsource.sym} -220 70 0 0 {name=VCM value=CACE\{Vcm\} savecurrent=true}
