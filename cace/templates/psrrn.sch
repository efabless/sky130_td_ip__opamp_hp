...
C {devices/vsource.sym} -680 -340 0 0 {name=V_AVDD value=CACE\{Vvdd\} savecurrent=true}
...
C {devices/lab_wire.sym} 210 0 0 0 {name=p10 sig_type=std_logic lab=vout_avss
}
...
let avss_db = db(vout_avss)
let psrrn_db = av_db - avss_db

meas AC psrrn_dc FIND psrrn_db AT=1
meas AC psrrn_10k FIND psrrn_db AT=10K

echo 
echo ===================================
echo PSRR- characterization results:
echo - PSRR @ 1 Hz: $&psrrn_dc
echo - PSRR @ 10 kHz: $&psrrn_10k
echo ===================================


echo $&psrrn_dc $&psrrn_10k > CACE\{simpath\}/CACE\{filename\}_CACE\{N\}.data
quit
.endc
"
...
C {devices/vsource.sym} -10 130 0 0 {name=V1 value="ac 1" savecurrent=false}
...
C {devices/vsource.sym} -760 170 0 0 {name=VCM value=CACE\{Vcm\} savecurrent=true}
