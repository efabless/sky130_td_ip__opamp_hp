...
C {devices/lab_wire.sym} 1280 -110 0 0 {name=p54 sig_type=std_logic lab=net9}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 1580 -60 3 0 {name=C3 model=cap_mim_m3_1 W=12 L=12 MF=9 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_1.sym} 1580 -140 3 0 {name=C1 model=cap_mim_m3_1 W=12 L=12 MF=9 spiceprefix=X}
...
C {sky130_fd_pr/cap_mim_m3_2.sym} 1470 -60 3 0 {name=C2 model=cap_mim_m3_2 W=12 L=12 MF=9 spiceprefix=X}
C {devices/lab_wire.sym} 1400 -60 2 1 {name=p260 sig_type=std_logic lab=resb_in}
C {sky130_fd_pr/cap_mim_m3_2.sym} 1470 -140 3 0 {name=C4 model=cap_mim_m3_2 W=12 L=12 MF=9 spiceprefix=X}
C {devices/lab_wire.sym} 1410 -140 2 1 {name=p262 sig_type=std_logic lab=resa_in}
