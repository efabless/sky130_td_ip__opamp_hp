...
set circuit1 [readnet spice ../netlist/layout/sky130_td_ip__opamp_hp_narrow.spice]
set circuit2 [readnet spice $hvlib]
readnet spice ../netlist/schematic/sky130_td_ip__opamp_hp_narrow.spice $circuit2

lvs "$circuit1 sky130_td_ip__opamp_hp_narrow" "$circuit2 sky130_td_ip__opamp_hp_narrow" \
        $setupfile sky130_td_ip__opamp_hp_narrow_comp.out
